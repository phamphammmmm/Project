...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = mysqli_prepare($conn, "INSERT INTO orders (order_id, customer_id, order_date, order_time, customer_name, phone_order, address) VALUES (?, ?, ?, ?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, "sssssss", $order_id, $customer_id, $order_date, $order_time, $customer_name, $phone_order, $address_order);
    ...
    $item_names = []; // Khởi tạo mảng lưu tên món ăn
    ...
    $(document).ready(function() {
        Swal.fire({
            title: "Đơn hàng ' . $item_name . ' đã được đặt thành công!",
            icon: "success",
